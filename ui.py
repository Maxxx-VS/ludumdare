...
class UIRenderer:
    ...
    def draw(self, frame, game, cur_pose, is_correct):
        ...
        # Статус (Зеленый "ВЕРНО", если успешно выполнено или в процессе паузы)
        ...
        timer_color = (255, 255, 255) if game.time_left > 10 else (255, 100, 100)
